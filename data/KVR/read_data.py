    ...
    for d in dialogues:
        if(d['scenario']['task']['intent']=="navigate"): #"schedule" "navigate"
            ...
            for i in range(0,len(d['dialogue']),2):
                ...
                if bot!="" and user!="":
                    gen_f.write(str(j)+" "+user+'\t'+bot+'\t'+str(gold_entity))
                    gen_f.write('\n')
            ...
            temp += global_temp
            # print("0 today " + d['scenario']['kb']['items'][0]["today"])
            gen_f.write("0 today " + d['scenario']['kb']['items'][0]["today"])
            gen_f.write('\n')
        ...
        if(d['scenario']['task']['intent']=="schedule"): #"schedule"
            ...
            if(d['scenario']['kb']['items'] != None):
                for el in d['scenario']['kb']['items']:
                    ...
                    temp.append(di)
                    # print("0 "+ev+" "+el['date'].replace(" ", "_")+" "+el['time'].replace(" ", "")+" "+el['party'].replace(" ", "_")+" "+el['room'].replace(" ", "_")+" "+el['agenda'].replace(" ", "_"))
                    gen_f.write("0 "+ev+" "+el['date'].replace(" ", "_")+" "+el['time'].replace(" ", "")+" "+el['party'].replace(" ", "_")+" "+el['room'].replace(" ", "_")+" "+el['agenda'].replace(" ", "_"))
                    gen_f.write('\n')
            temp += global_temp
